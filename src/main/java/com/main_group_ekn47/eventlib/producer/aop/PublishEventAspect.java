...
public class PublishEventAspect {
    ...
    //@Around("@annotation(com.main_group_ekn47.eventlib.producer.annotation.PublishEvent)")
    // CORRECCIÓN: Usar la anotación con la ruta correcta
